...
_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3)#!/usr/bin/env sage
...
def get_point_group_gens(cryst_num, dim=_sage_const_3 ):
